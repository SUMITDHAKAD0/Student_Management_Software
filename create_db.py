...
def create_db():
    ...
    cur.execute('CREATE TABLE IF NOT EXISTS emp(eid INTEGER PRIMARY KEY AUTOINCREMENT, fname text, lname text, contact text, email text, question text, answer text, password text)')
    con.commit()
